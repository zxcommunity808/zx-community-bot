...
var trackedPromise = require('../promise/tracked-promise.cjs');
var planBeat = require('./plan-beat.cjs');
...
class Runner {
    ...
    start() {
        ...
        const heartBeat = async () => {
            ...
            const plan = planBeat.planBeat(expectedNextExecution, currentDate, this.missedExecutionTolerance, (date) => this.timeMatcher.getNextMatch(date));
            ...
            if (plan.run) {
                ...
                const slot = plan.run;
                lastExecution = new trackedPromise.TrackedPromise(async (resolve, reject) => {
                    try {
